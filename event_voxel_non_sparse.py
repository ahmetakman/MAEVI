...
class EventVoxel(Dataset):
    def __init__(self, data_root, is_hsergb, is_training, is_validation, number_of_time_bins, number_of_skips=1):
        ...
        if is_hsergb:
            ...
            train_fn = os.path.join(self.data_root, 'set_data_bsergb_training_n.txt')
            test_fn = os.path.join(self.data_root, 'set_data_bsergb_test_n.txt')
            valid_fn = os.path.join(self.data_root, 'set_data_bsergb_validation_n.txt')
    ...
    def __getitem__(self, index):
        ...
        voxel = torch.nn.functional.interpolate(voxel, size=(624, 968))
